...
export default function HeaderArticle({ post, siteInfo }) {
  ...
  return (
    <div
      id="header"
      className="my-article-header w-full h-96 relative md:flex-shrink-0 overflow-hidden bg-cover bg-center bg-no-repeat animate__animated animate__fadeIn relative"
    ...
    >
      <header className="animate__slideInDown animate__animated bg-black bg-opacity-70 absolute top-0 w-full h-96 py-10 flex justify-center items-center ">
        <div className=''>
          {/* 文章Title */}
		  <div className="font-bold md:text-5xl shadow-text flex justify-center text-center text-white dark:text-white ">
            {post.title}
          </div>
