...
const BLOG = {
  ...
  AUTHOR: '叶修齐', // 您的昵称 例如 tangly1024
  BIO: '温柔，风色。', // 作者简介
  LINK: 'https://siuze.top', // 网站地址
  KEYWORDS: '少年游, Notion, GitHub, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'ieksiuze@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: 'https://weibo.com/u/1967802173/', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/siuze', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai'
    'Optima', ,"HarmonyOS","HarmonyOS_Regular",'"PingFang SC"','"Apple Color Emoji"',
    '"Segoe UI Emoji"', '"Segoe UI Symbol"', '"Segoe UI"', '"Noto Sans SC"',
    '"Microsoft YaHei"', 
    'Arial', 'sans-serif'],
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '闽ICP备19021163号', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GISCUS_CATEGORY_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIejAP84CSr2o', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  NOTION_PROPERTY_NAME: {
    ...
    status_invisible: process.env.NEXT_PUBLIC_NOTION_PROPERTY_STATUS_INVISIBLE || '未发布', // 当status状态值与此相同时为隐藏发布，可以为中文 ， 除此之外其他页面状态不会显示在博客上
